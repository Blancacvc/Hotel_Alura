	 ...
	 private void headerMousePressed(java.awt.event.MouseEvent evt) {
	    	...
	    	try {
				for (Reservas res : reserva) {
					modelo.addRow(new Object[] {
							res.getId(),res.getFecha_entrada(),res.getFecha_salida(),res.getValor(),res.getForma_pago()
					});
				}
			} catch (Exception e) {
				throw e;
	    	...
	    	try {
				for (Huespedes huespedes1 : huespedes ) {
					modeloH.addRow(new Object[] {
							...
							huespedes1.getFecha_de_nacimiento(), huespedes1.getNacionalidad(), huespedes1.getTelefono(),huespedes1.getId_Reserva()
					});
				}
			} catch (Exception e) {
				throw e;
	    ...
	    private void ActualizarReservas() {
	    	...
	    	.ifPresentOrElse(fila ->{
	    		...
	    		this.reservasControl.actualizar(fecha_entrada, fecha_salida, valor, forma_pago, id);
	    ...
	    private void actualizarHuespedes() {
	    	...
	    	.ifPresentOrElse(filaHuespedes ->{
	    		...
	    		Date fecha_de_nacimiento = Date.valueOf(modeloH.getValueAt(tbHuespedes.getSelectedRow(),3 ).toString());
	    		...
	    		this.huespedesControl.actualizar(nombre, apellido, fecha_de_nacimiento, nacionalidad, telefono,id_Reserva);
	    		JOptionPane.showMessageDialog(this, String.format("Registro Modificado con exito"));
